...
// Players
team.players = new createManager(function () {
	var requestParams = {
...
// Youngs
team.youngs = new createManager(function () {
	var requestParams = {
...
// Finance
team.finance = new createManager(function () {
	var requestParams = {
...
team.nearMatch =  new createManager(function () {
	var requestParams = {
